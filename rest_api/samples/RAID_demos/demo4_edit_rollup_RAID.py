...
#ivy.create_workload(workload="steady", select = "", iogenerator = "random_steady", parameters = "fractionRead=100%, IOPS=max, maxTags=32")

ivy.create_workload(workload="steady", select = "", iosequencer = "random_steady", parameters = "fractionRead=100%, IOPS=max, maxTags=32")
